...
const ProjectCard = ({ image, title, category, link, myGrad }) => {
  return (
    <div className="">
      <div className="w-full relative flex flex-col my-6 md:mb-6 md:mt-0 items-center justify-center md:borderBottom md:py-10 md:px-5 pb-3 md:pb-0">
        ...
        <div className={`absolute w-full h-full left-0 top-0 hover:bg-gradient-to-t ${myGrad} opacity-20 rounded-lg`}></div>
      </div>
    </div>
  );
};
